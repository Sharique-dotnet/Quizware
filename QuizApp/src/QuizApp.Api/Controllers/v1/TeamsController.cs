...
using QuizApp.Application.Teams.Commands;
using QuizApp.Application.Teams.Dtos;
using QuizApp.Application.Teams.Queries;
using QuizApp.Domain.Enums;
using QuizApp.Infrastructure.Imports;
...
public sealed class TeamsController : ControllerBase
{
        ...
        Guid programId, Guid batchId, CancellationToken cancellationToken)
    {
        ...
        foreach (var row in validRows)
        {
            ...
            catch (Exception ex) when (ex is KeyNotFoundException or QuizApp.Domain.Common.Exceptions.InvalidStateTransitionException)
            {
                row.IsValid = false;
    ...
    private static TeamDetailResponse ToDetailResponse(TeamDto dto) => new(
        ...
        dto.Members
            .Select(m => new QuizApp.Api.Contracts.V1.Teams.TeamMemberDto(
